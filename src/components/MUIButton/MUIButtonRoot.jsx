...
export default styled(Button)(({ theme, ownerState }) => {
  ...
  const getContainedStyles = () => {
    ...
    if (!isDarkMode && (color === 'white' || color === 'light' || !palette[color])) {
      colorValue = text.main;
    } else if (isDarkMode && (color === 'white' || color === 'light' || !palette[color])) {
      colorValue = grey[600];
    }
  ...
  return {
    ...
    ...(variant === 'outlined' && getOutliedStyles()),
